...
const TheResponsive = () => {
    return (
        <section className=":uno: py-12">
            <Container>
                <img className=":uno: w-full md:w-2/5 md:mx-auto md:block mb-8" src={img} alt="" />
                <div className=":uno: capitalize text-center text-xl font-semibold text-primary-900"> customize your interface</div>
                <p className=":uno: text-center text-sm leading-6 font-medium">
